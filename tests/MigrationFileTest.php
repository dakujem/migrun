...
{
    public function testStoresPathIdAndName(): void
    {
        ...
        self::assertSame('create_users', $file->name());
    }

    public function testNameIsNullableAndDefaultsToNull(): void
    {
        $file = new MigrationFile(
            path: '/migrations/some_migration.php',
            id: 'some_migration',
        );
